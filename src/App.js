  ...
  return (
    <div>
      ...
      <div className="mx-5 md:mx-24 lg:mx-44 2xl:mx-96 mt-12">
        ...
        <h6 className="opacity-60 text-sm"><i>By the way, I'm making this logo for Hackapet, a new YSWS I'm running! You should totally join #hackapet on the Slack :D</i></h6>
